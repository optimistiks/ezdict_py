...
angular.module('toaster', ['ngAnimate'])
    .service('toaster', ['$rootScope', function ($rootScope) {
        ...
        this.save = function (type, title, body, timeout, trustedHtml) {
            var argsAsString = Array.prototype.slice.call(arguments).join('|');
            createCookie('toast', argsAsString);
        };

        this.popSaved = function () {
            var args = readCookie('toast');
            if (args) {
                this.pop.apply(this, args.split('|'))
            }
            eraseCookie('toast');
        }
    }])

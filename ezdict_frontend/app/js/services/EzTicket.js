define(['./module', './ErrorsHandlerMixin'], function (factory, ErrorsHandlerMixin) {
    'use strict';
    factory.
        factory('EzTicket', ['$resource', 'constants', '$window', '$q', function ($resource, constants, $window, $q) {
            ...
            EzTicket.prototype = $window.angular.extend(EzTicket.prototype, ErrorsHandlerMixin);

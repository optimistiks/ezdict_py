...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tickets_ticket', 'user',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tickets_ticket', 'user_id')
    ...
    models = {
        ...
        'tickets.ticket': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'to': "orm['accounts.MyUser']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MyUser'
        db.create_table('accounts_myuser', (
            ...
            ('nickname', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_admin', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('accounts', ['MyUser'])


    def backwards(self, orm):
        # Deleting model 'MyUser'
        db.delete_table('accounts_myuser')
